...
# def getNameEmojiMessage():
#     # lookUpStr = string.ascii_ippercase + string.ascii_lowercase
#     # nihnk = "あいうえおかきくけこさしすせそたちつてとなにぬねのはひふへほまみむめもやゆよらりるれろわをんァィゥェォカキクケコサシスセソタチツテトナニヌネノハヒフヘホマミムメモヤユヨラリルレロワヲン"

#     lookUpStr = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz"
#     productId = "5ac21a8c040ab15980c9b43f"
#     # productId = "5ac21cce040ab15980c9b443"
#     # name = "メスガキ"
#     name = "Wesenpap"
#     emojis = list()
#     text = "$"*len(name)
...
def getHandsome():
    message={
        "type": "image",
        "originalContentUrl": F"{end_point}/static/IMG_1019.jpg",
        "previewImageUrl": F"{end_point}/static/IMG_1019.jpg"
